...
| [检查链接可访问性](#检查链接可访问性) | 批量检查选中目录下所有 markdown 和 _toc.yaml 涉及链接的可访问性 |
| [检查目录和文件是否符合命名规范](#检查目录和文件是否符合命名规范) | 批量检查选中目录下的文件和子目录名字是否符合命名规范 |
| [检查中英文文档名称一致性](#检查中英文文档名称一致性) | 批量检查选中目录下 Markdown 中英文文档名称是否一致 |
...
1. 安装并启用本插件；
2. 右键点击对应目录：选择菜单`Doc Tools`，再选择`检测链接可访问性`选项；
...
3. 选择菜单`Doc Tools`，再选择`检查目录、文件是否符合命名规范`选项；
...
1. 安装并启用本插件；
2. 在资源管理器中右键点击需要检查的目录；
3. 选择菜单`Doc Tools`，再选择`检查中英文文档名称一致性`选项；
